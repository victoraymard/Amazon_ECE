                                ...
                                <form action="inscription_vendeur.php" method="post">
                                    <div class="row register-form">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Compositeur *" value="" name="Compositeur"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Album *" value="" name="Album" />
                                        </div>                                   
