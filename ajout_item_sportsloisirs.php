...
<head>
    ...
    <title>Amazon ECE - ajout sports/loisirs</title>
</head>
<body>
    <div id="bloc_page">
        <header>
        ...
        <div id= "corps">
            <div class="jumbotron text-center">
                <h2>Formulaire d'insertion d'accessoires de sports et loisirs</h2>
            </div>
                    ...
                    <div class="col-md-9 register-right">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Ajout sports / loisirs</h3>
                                <form action="inscription_vendeur.php" method="post">
                                    <div class="row register-form">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Nom de l'activité *" value="" name="Activite" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">                                   
