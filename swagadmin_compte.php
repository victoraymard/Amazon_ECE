...
<head>
  ...
  <style type="text/css">
    ...
    .jumbotron-heading a{color: darkred; font-weight: bold;text-shadow: 2px 2px black;}
    .jumbotron-heading a:hover{color: darkred; text-decoration: none;text-shadow: 2px 2px black;}
  </style>
...
<body>
  <div id="bloc_page" >
    ...
    <section class="jumbotron text-center">
     <h1 class="jumbotron-heading"><a href="admin_compte.php">Espace administrateur</a></h1>
   </section>
  ...
  <div id="footer">
    ...
    <small>
      ...
      <audio cont rols autoplay><source src="images/admin.mp3" type="audio/mpeg"></audio>
      </small>
    </div>
  </div>
