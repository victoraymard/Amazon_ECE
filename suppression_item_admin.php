...
if($db_found)
{
    ...
    $sql20 = "DELETE FROM Livre WHERE ID_Item = ".$ID_Item;
    mysqli_query($db_handle, $sql10) or die (mysqli_error($db_handle));

    $sql30 = "DELETE FROM Livre WHERE ID_Item = ".$ID_Item;
    mysqli_query($db_handle, $sql10) or die (mysqli_error($db_handle));

    $sql3 = "DELETE FROM Item WHERE Pseudo_Vendeur ='".$itemSelect[0]['Pseudo_Vendeur']."' AND ID_Item =".$ID_Item;
